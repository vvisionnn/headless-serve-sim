 ...
 *
 * Requires an explicitly leased simulator from the system-test harness. It exercises the Swift
...
describeWithSim(
  `headless-serve-sim AVCC endpoint (booted sim ${bootedUdid ?? "<skipped>"})`,
  () => {
    let avccUrl: string;
