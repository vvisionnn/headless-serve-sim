...
// control drives `headless-serve-sim ui <option> <value>`, which handles the
// simctl-native options (appearance, contrast, text size) and the private-
// setter ones (liquid glass, color filter, reduce motion, …) uniformly.
