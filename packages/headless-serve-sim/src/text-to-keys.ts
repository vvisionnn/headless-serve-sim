...
// keyboard events (`down`/`up`) suitable for the headless-serve-sim WS key opcode (0x06).
//
...
/** Send a sequence of key events to a headless-serve-sim WS endpoint using the 0x06
